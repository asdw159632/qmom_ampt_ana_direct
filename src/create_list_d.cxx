...
int makelist(int argc, char *argv[]){
	...
	ofstream listout;
	listout.open("../list/rawdatapath.list");
	if(listout.fail()){
...
#ifdef byrun
			listout<<argv[1]<<"run"<<argc<<"/data-"<<j1<<".root"<<endl;
#else
...
/*if (argc ==4){
	ofstream listout;
	listout.open("../list/inputpath.list");
	if(listout.fail()){
		cout<<"Sorry, couldn¡¯t open file"<<endl;
		exit(1);
	}
...
if (argc >=3){
	ofstream listout;
	listout.open("../list/outputdirpath.list");
	if(listout.fail()){
...
//	if(argc==4)cout<<"there are "<<m<<" save-directions"<<endl;
	cout<<"//////////////////////////////////////////////"<<endl;
	cout<<endl;
	cout<<"creating list finished at "<<endl;
	system("date");
	cout<<endl;
	cout<<"//////////////////////////////////////////////"<<endl;
